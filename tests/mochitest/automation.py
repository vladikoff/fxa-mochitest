...
_DIST_BIN = "/builds/slave/ash-m64-ntly-00000000000000000/build/src/obj-firefox/i386/dist/bin"
_IS_WIN32 = len("") != 0
_IS_MAC = 1 != 0
_IS_LINUX = 0 != 0
_IS_CYGWIN = False
...
_DEFAULT_APP = "./" + "../../../dist/Nightly.app/Contents/MacOS/firefox-bin"
_CERTS_SRC_DIR = "/builds/slave/ash-m64-ntly-00000000000000000/build/src/build/pgo/certs"
_IS_TEST_BUILD = 1
_IS_DEBUG_BUILD = 0
_CRASHREPORTER = 1 == 1
_IS_ASAN = 0 == 1
